...
Parse.Cloud.define("getProfile", function (request, response) {
    ...
    varQuery.include("casteId");
    varQuery.include("religionId");
    varQuery.include("education1.degreeId");
    varQuery.include("industryId");
...
Parse.Cloud.define("matchKundli", function (request, response) {
    ...
    Parse.Promise.when(promises).then(function () {
        ...
        Parse.Promise.when(promises1).then(function () {
            ...
            var urlText = "http://astro.taskb.in/astro/index.php?kBirthDate=" + kanyaProfile.get('dob').getDate() + "-" + kDob + "-" + kanyaProfile.get('dob').getFullYear() + "&kActualBirthDate=" + kanyaProfile.get('dob').getDate() + "-" + kDob + "-" + kanyaProfile.get('dob').getFullYear() + "&kLat=" + parseFloat(kanyaCity.get('latitude')).toFixed(7) + "&kLng=" + parseFloat(kanyaCity.get('longitude')).toFixed(7) + "&ktz=+5.5&kBirthTime=" + kanyaProfile.get('tob').getHours() + ":" + kanyaProfile.get('tob').getMinutes() + ":" + kanyaProfile.get('tob').getSeconds() + "&vBirthDate=" + varProfile.get('dob').getDate() + "-" + (parseInt(varProfile.get('dob').getMonth()) + 1) + "-" + varProfile.get('dob').getFullYear() + "&vActualBirthDate=" + varProfile.get('dob').getDate() + "-" + (parseInt(varProfile.get('dob').getMonth()) + 1) + "-" + varProfile.get('dob').getFullYear() + "&vLat=" + parseFloat(varCity.get('latitude')).toFixed(7) + "&vLng=" + parseFloat(varCity.get('longitude')).toFixed(7) + "&vtz=+5.5&vBirthTime=" + varProfile.get('tob').getHours() + ":" + varProfile.get('tob').getMinutes() + ":" + varProfile.get('tob').getSeconds();
